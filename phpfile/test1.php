...
set_time_limit(0);
$url_test ='http://9mouth.lofter.com/';
...
//设置代理服务器，proxytunnel为1表示需要使用代理服务器
    ...
    curl_setopt($curl,
        CURLOPT_PROXY, 'jp.1mo.igaotizi.com:2506');

    curl_setopt($curl,
        CURLOPT_PROXYUSERPWD, '87420318');*/
...
//保存数据
        ...
        fclose($handle);
        echo $name," has download! </br>!!!!!!!!!!!!!!!!!!!!!!</br></br></br>";
    }
//*******************
