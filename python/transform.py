...
key = 'lCxSdtESkP6oqvHCGMVeT5CHv51cPTk6'  # 这里填写你的百度开放平台的key
...
def __init__(import_path, trans_path):
    f = open(trans_path, "w")
    for line in open(import_path):
        try:
